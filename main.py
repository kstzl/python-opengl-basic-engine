...
if __name__ == "__main__":
    ...
    floor_material = Material(shader_program=default_shader, texture=Texture("./assets/textures/tile.jpg"))
    wall_material = Material(shader_program=default_shader, texture=Texture("./assets/textures/metrotile.jpg"))
