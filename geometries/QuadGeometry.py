...
class QuadGeometry(DrawableActor):
    def __init__(self) -> None:
        ...
        self.vtxc.add_vertex(x=-0.5, y=0.5, z=0.0, r=1.0, g=1.0, b=1.0, u=0.0, v=1.0)
        self.vtxc.add_vertex(x=0.5, y=0.5, z=0.0, r=1.0, g=1.0, b=1.0, u=1.0, v=1.0)
        self.vtxc.add_vertex(x=-0.5, y=-0.5, z=0.0, r=1.0, g=1.0, b=1.0, u=0.0, v=0.0)

        self.vtxc.add_vertex(x=0.5, y=0.5, z=0.0, r=1.0, g=1.0, b=1.0, u=1.0, v=1.0)
        self.vtxc.add_vertex(x=0.5, y=-0.5, z=0.0, r=1.0, g=1.0, b=1.0, u=1.0, v=0.0)
        self.vtxc.add_vertex(x=-0.5, y=-0.5, z=0.0, r=1.0, g=1.0, b=1.0, u=0.0, v=0.0)
        ...
        self.vao.enable_and_set_attribute_ptr(2, 2, GL.GL_FLOAT, GL.GL_FALSE, 32, 24)
